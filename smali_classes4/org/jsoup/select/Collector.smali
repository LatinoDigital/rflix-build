...
.method public static collect(Lorg/jsoup/select/Evaluator;Lorg/jsoup/nodes/Element;)Lorg/jsoup/select/Elements;
    ...
    invoke-static {v0, p0}, Lokhttp3/Headers$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/Stream;Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object p0

    new-instance p1, Lorg/jsoup/select/Collector$$ExternalSyntheticLambda2;

    invoke-direct {p1}, Lorg/jsoup/select/Collector$$ExternalSyntheticLambda2;-><init>()V

    .line 29
    invoke-static {p1}, Lokhttp3/Headers$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/function/Supplier;)Ljava/util/stream/Collector;
...
.method public static findFirst(Lorg/jsoup/select/Evaluator;Lorg/jsoup/nodes/Element;)Lorg/jsoup/nodes/Element;
    ...
    invoke-static {p0}, Lokhttp3/Headers$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/Stream;)Ljava/util/Optional;
    ...
    .line 43
    invoke-static {p0, p1}, Lokhttp3/Headers$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/Optional;Ljava/lang/Object;)Ljava/lang/Object;
